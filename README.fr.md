...
1.  `demoStrategy` - un exemple d'illustration simple qui sert de point de départ pour créer de nouvelles stratégies
2.  `backendStrategy` - un exemple légèrement plus complet où le LLM travaille sur une application Fastify locale (fonctionnant sur http://localhost:8080) pour créer des migrations de base de données et des points de terminaison API
