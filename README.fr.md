...
2.  `backendStrategy` - un exemple un peu plus complet où le LLM travaille sur une application Fastify locale (s'exécutant sur http://localhost:8080) pour créer des migrations de base de données et des endpoints API
